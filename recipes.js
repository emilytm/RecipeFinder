export default [
    ...
    },
    {
        ...
        tags: ['Baking','Chocolate','Classic','Twist'],
        lastmade: 'December 20, 2022',
        ingredients: ['Dutch Process Cocoa', 'Flour', 'Sugar', 'Malted Milk Powder'],
        time: {
            active: '2.5 hrs',
            total: '3.25 hrs'
        }
